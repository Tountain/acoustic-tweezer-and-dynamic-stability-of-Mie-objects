...
theta_w = linspace(0, pi, 5*10^3);
% theta_w = [linspace(0, pi/4-10^-5, 5*10^3) linspace(pi/4, 3*pi/4-10^-5, 1*10^3) linspace(3*pi/4, pi, 5*10^3)];  % for oblate objects
% theta_w = [linspace(0, 2*pi/6-10^-5, 0.5*10^3) linspace(2*pi/10, 4*pi/10-10^-5, 10*10^3) linspace(4*pi/6, pi, 0.5*10^3)];  % for prolate objects
