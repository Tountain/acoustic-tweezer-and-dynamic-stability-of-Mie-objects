...
%
% my derivation (a)&(b)[testing_type == 1&2] are coincide with
% G.T.S@2012(IEEE) [testing_type == 4]
%
% my derivation for arbitrary incidence angle, which is for [testing_type =
% 3].
%
...
if (strcmp(wave_type, 'single_transducer') || strcmp(wave_type, 'phase_array_transducer') || strcmp(wave_type, 'phase_array_transducer2')) ~= 1
    ...
    if multi_particle == 0
        if multi_layer == 0
            save([dir_file_torques_trans, 'A.mat'], 'E0', 'pi_a3_E0', 'transducer', 'A_delay', 'phi_delay', 'Torque_x', 'Torque_y', 'Torque_z');
        elseif multi_layer == 1
            save([dir_file_torques_trans, 'A.mat'], 'E0', 'pi_a3_E0', 'transducer', 'A_delay', 'phi_delay', 'Torque_x', 'Torque_y', 'Torque_z', 'c_layer', 'density_layer' , 'depth_fun');
        end
    else
        particles_Cartesian_data;
        ...
        if multi_layer == 0
            save([dir_file_torques_trans, 'A.mat'], 'E0', 'pi_a3_E0', 'transducer', 'A_delay', 'phi_delay', ...
                'Torque_x', 'Torque_y', 'Torque_z', 'particle', 'multi_particle_radius');
        elseif multi_layer == 1
            save([dir_file_torques_trans, 'A.mat'], 'E0', 'pi_a3_E0', 'transducer', 'A_delay', 'phi_delay', ...
                'Torque_x', 'Torque_y', 'Torque_z', 'particle', 'multi_particle_radius', 'c_layer', 'density_layer' , 'depth_fun');
