...
if multi_particle ~= 0
    ...
    db_filename_ts = ['TranslationCoeff_size_', num2str(db_size_nn), ...
                    ...
                    '_X0(ka)', num2str(roundn(X0/particle_radius, -1)), ...
                    '_Y0(ka)', num2str(roundn(Y0/particle_radius, -1))];
    db_filename_str = ['StructureCoeff_size_', num2str(db_size_nn), ...
                    '_', wave_type, ...
                    '_', BC, ...
                    '_BN', num2str(BN), ...
                    '_beta', num2str(roundn(BETA,-2)), ...
...
% ==========================================================
% ======== database files' for Characteristic matrix =======

if strcmp(wave_type, 'phase_array_transducer') == 1 || strcmp(wave_type, 'phase_array_transducer2') == 1
    db_filename_CharMat = ['CharMatrix_size_', num2str(transducer_number), ...
                    '_', wave_type, '_', BC];
end
if strcmp(wave_type, 'phase_array_transducer') == 1 || strcmp(wave_type, 'phase_array_transducer2') == 1
    db_filename_EQ_VIII = ['EQ_VIII_size_', num2str(transducer_number), ...
                    '_', wave_type, '_', BC];
end
if strcmp(wave_type, 'phase_array_transducer') == 1 || strcmp(wave_type, 'phase_array_transducer2') == 1
    db_filename_EQ_X = ['EQ_X_size_', num2str(transducer_number), ...
                    '_', wave_type, '_', BC];
end
if strcmp(wave_type, 'phase_array_transducer') == 1 || strcmp(wave_type, 'phase_array_transducer2') == 1
    db_filename_EQ_XII = ['EQ_XII_size_', num2str(transducer_number), ...
                    '_', wave_type, '_', BC];
end

db_filename_ts_partial = ['Partial_TranslationCoeff_size_', num2str(db_size_nn), ...
                    '_', wave_type, ...
                    '_', BC, ...
                    '_BN', num2str(BN), ...
                    '_beta', num2str(roundn(BETA,-2)), ...
...
filename = ['irreg_', num2str(irregular_body), '_', ...
            'Cn_', num2str(length(Cn)), num2str(roundn(Cn(end)/particle_radius, -2)), '_', ...
            'RotM_', num2str(rot_matrix), '_', ...
            '(', num2str(roundn(theta_x*180/pi, 0)), ',', num2str(roundn(theta_y*180/pi, 0)), ',', num2str(roundn(theta_z*180/pi, 0)), ')_', ...
            'ML_', num2str(multi_layer), '_', ...
            'Pin_', num2str(roundn(p_inlet, -2)), 'Pa', ...
            '_', wave_type, num2str(BN), '_', num2str(roundn(BETA*180/pi, 0)), ...
            '_a', num2str(round(10^6*particle_radius)), 'um', ...
            '_freq', num2str(round(10^-3*freq)), 'kHz', ...
            '_X1(pr)', num2str(roundn(deviationX/particle_radius, -5)), ...
            '_Y1(pr)', num2str(roundn(deviationY/particle_radius, -5)), ...
            '_Z1(pr)', num2str(roundn(deviationZ/particle_radius, -5)), ...
            '_', BC, ...
...
elseif multi_layer == 1
    if (strcmp(wave_type, 'single_transducer') || strcmp(wave_type, 'phase_array_transducer') || strcmp(wave_type, 'phase_array_transducer2')) == 1
        filename = [filename, '_b', num2str(b/particle_radius), 'a_trans', num2str(transducer_number), '(', num2str(trans_radius*1000), 'mm)_dist1_', num2str(inter_dist_source_layer*1000), 'mm_dist2_', num2str(inter_dist*1000), 'mm'];
        filename = [filename, '_Rot', num2str(roundn(theta_x*180/pi, -0)), '_', num2str(roundn(theta_y*180/pi, -0)), '_', num2str(roundn(theta_z*180/pi, -0))];
    end
end
...
dir_file_forces_partial = ['.\data_forces_', fluid, '\P', filename];
dir_file_torques_partial = ['.\data_torques_', fluid, '\P', filename];
...
dir_file_forces_trans_partial = ['.\data_forces_transducer_', fluid, '\P', filename];
dir_file_torques_trans_partial = ['.\data_torques_transducer_', fluid, '\P', filename];
